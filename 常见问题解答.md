...
训练脚本：<br>
可先跑通WebUI，消息窗内会显示数据集处理和训练用命令行；训练前，按照你预先的前端训练的尝试生成的filelist.txt的格式准备一份filelist.txt<br>
...
推理脚本：https://huggingface.co/lj1995/VoiceConversionWebUI/blob/main/myinfer-v2-0528.py<br>
